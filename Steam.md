...
# Launch a game, close it and locate a proton prefix. Should be in:
...
Create run_burrito_link.sh file. Make it executable. It's contents should be something like this below (didn't test whether everything there is required):
